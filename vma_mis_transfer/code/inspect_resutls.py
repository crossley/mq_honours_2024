...
dp = d.groupby(["condition", "session", "phase", "trial", "target_angle", "rotation"],
...
ax[0, 0].plot(dp[dp["session"]==1].trial, dp[dp["session"]==1].rotation * 2, color="black", linestyle="-")
ax[1, 0].plot(dp[dp["session"]==2].trial, dp[dp["session"]==2].rotation * 2, color="black", linestyle="-")
